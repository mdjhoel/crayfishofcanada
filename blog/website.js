function loadJSON(callback) {   
 ...
 function init() {
 	loadJSON(function(response) {
        ...
        slab.push("<script src='https://code.jquery.com/jquery-3.3.1.min.js'></script>");
    	slab.push("<link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css'>");
        slab.push("<script src='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js'></script>");
    	...
    	slab.push("</header>");
    	slab.push("<nav class='navbar navbar-inverse navbar-fixed-top' role='navigation'><div class='container'><div class='navbar-header'><button type='button' class='navbar-toggle collapsed' data-toggle='collapse' data-target='#bs-example-navbar-collapse-1'><span class='sr-only'>Toggle navigation</span><span class='icon-bar'></span><span class='icon-bar'></span><span class='icon-bar'></span></button></div><div class='collapse navbar-collapse' id='bs-example-navbar-collapse-1'><img src='../cray.svg' width='30px'/><ul class='nav navbar-nav navbar-right'><a id='mylink' href='../about.html'>About</a> |<a id='mylink' href='../gallery.html'>Gallery</a> |<a id='mylink' href='../stories.html'>Stories</a> |<a id='mylink' href='index.html'>Blog</a></ul></div></div></nav>");
